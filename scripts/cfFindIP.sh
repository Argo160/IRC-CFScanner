...
function fncMainCFFind {
	...
	then
		case $IpNo in
        		45) cfSubnetList=$(cat "$scriptDir"/ip/cf.45.iplist);;
        		103) cfSubnetList=$(cat "$scriptDir"/ip/cf.103.iplist);;
        		104) cfSubnetList=$(cat "$scriptDir"/ip/cf.104.iplist);;
        		108) cfSubnetList=$(cat "$scriptDir"/ip/cf.108.iplist);;
        		12) cfSubnetList=$(cat "$scriptDir"/ip/cf.12.iplist);;
        		123) cfSubnetList=$(cat "$scriptDir"/ip/cf.123.iplist);;
        		141) cfSubnetList=$(cat "$scriptDir"/ip/cf.141.iplist);;
        		146) cfSubnetList=$(cat "$scriptDir"/ip/cf.146.iplist);;
        		147) cfSubnetList=$(cat "$scriptDir"/ip/cf.147.iplist);;
        		154) cfSubnetList=$(cat "$scriptDir"/ip/cf.154.iplist);;
        		156) cfSubnetList=$(cat "$scriptDir"/ip/cf.156.iplist);;
        		159) cfSubnetList=$(cat "$scriptDir"/ip/cf.159.iplist);;
        		160) cfSubnetList=$(cat "$scriptDir"/ip/cf.160.iplist);;
        		162) cfSubnetList=$(cat "$scriptDir"/ip/cf.162.iplist);;
        		168) cfSubnetList=$(cat "$scriptDir"/ip/cf.168.iplist);;
        		170) cfSubnetList=$(cat "$scriptDir"/ip/cf.170.iplist);;
        		172) cfSubnetList=$(cat "$scriptDir"/ip/cf.172.iplist);;
        		174) cfSubnetList=$(cat "$scriptDir"/ip/cf.174.iplist);;
        		176) cfSubnetList=$(cat "$scriptDir"/ip/cf.176.iplist);;
        		185) cfSubnetList=$(cat "$scriptDir"/ip/cf.185.iplist);;
        		188) cfSubnetList=$(cat "$scriptDir"/ip/cf.188.iplist);;
        		191) cfSubnetList=$(cat "$scriptDir"/ip/cf.191.iplist);;
        		192) cfSubnetList=$(cat "$scriptDir"/ip/cf.192.iplist);;
        		193) cfSubnetList=$(cat "$scriptDir"/ip/cf.193.iplist);;
        		194) cfSubnetList=$(cat "$scriptDir"/ip/cf.194.iplist);;
        		195) cfSubnetList=$(cat "$scriptDir"/ip/cf.195.iplist);;
        		196) cfSubnetList=$(cat "$scriptDir"/ip/cf.196.iplist);;
        		199) cfSubnetList=$(cat "$scriptDir"/ip/cf.199.iplist);;
        		202) cfSubnetList=$(cat "$scriptDir"/ip/cf.202.iplist);;
        		203) cfSubnetList=$(cat "$scriptDir"/ip/cf.203.iplist);;
        		204) cfSubnetList=$(cat "$scriptDir"/ip/cf.204.iplist);;
        		205) cfSubnetList=$(cat "$scriptDir"/ip/cf.205.iplist);;
        		206) cfSubnetList=$(cat "$scriptDir"/ip/cf.206.iplist);;
        		207) cfSubnetList=$(cat "$scriptDir"/ip/cf.207.iplist);;
        		208) cfSubnetList=$(cat "$scriptDir"/ip/cf.208.iplist);;
        		212) cfSubnetList=$(cat "$scriptDir"/ip/cf.212.iplist);;
        		216) cfSubnetList=$(cat "$scriptDir"/ip/cf.216.iplist);;
        		23) cfSubnetList=$(cat "$scriptDir"/ip/cf.23.iplist);;
        		31) cfSubnetList=$(cat "$scriptDir"/ip/cf.31.iplist);;
        		38) cfSubnetList=$(cat "$scriptDir"/ip/cf.38.iplist);;
        		5) cfSubnetList=$(cat "$scriptDir"/ip/cf.5.iplist);;
        		64) cfSubnetList=$(cat "$scriptDir"/ip/cf.64.iplist);;
        		65) cfSubnetList=$(cat "$scriptDir"/ip/cf.66.iplist);;
        		72) cfSubnetList=$(cat "$scriptDir"/ip/cf.72.iplist);;
        		80) cfSubnetList=$(cat "$scriptDir"/ip/cf.80.iplist);;
        		89) cfSubnetList=$(cat "$scriptDir"/ip/cf.89.iplist);;
        		91) cfSubnetList=$(cat "$scriptDir"/ip/cf.91.iplist);;
        		93) cfSubnetList=$(cat "$scriptDir"/ip/cf.93.iplist);;
        		95) cfSubnetList=$(cat "$scriptDir"/ip/cf.95.iplist);;
			*) exit;;
		esac
